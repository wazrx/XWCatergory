...
+ (BOOL)xwAdd_isWXAppInstalled{
    return [self isWXAppInstalled];
}

+ (BOOL)xwAdd_isWXAppSupportApi{
    return [self isWXAppSupportApi];
}

+ (BOOL)xwAdd_isWXEable{
    return [self isWXAppInstalled] && [self isWXAppSupportApi];
}
